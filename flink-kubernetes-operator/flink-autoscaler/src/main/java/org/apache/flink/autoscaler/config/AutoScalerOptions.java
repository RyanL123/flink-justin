...
public class AutoScalerOptions {
    ...
    public static final ConfigOption<Double> MIN_IMPROVED_THROUGHPUT =
            autoScalerConfig("min-improved-throughput")
                    .doubleType()
                    .defaultValue(0.05);
    ...
    // A4S Configuration Options

    public static final ConfigOption<Boolean> A4S_ENABLED =
            autoScalerConfig("a4s.enabled")
                    .booleanType()
                    .defaultValue(false)
                    .withDescription(
                            "Enable A4S co-designed scaling and placement algorithm. "
