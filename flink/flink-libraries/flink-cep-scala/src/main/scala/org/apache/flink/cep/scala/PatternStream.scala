...
class PatternStream[T](jPatternStream: JPatternStream[T]) {
  ...
  def select[L: TypeInformation, R: TypeInformation](
      ...
      patternSelectFunction: PatternSelectFunction[T, R]): DataStream[Either[L, R]] = {
  ...
  def flatSelect[L: TypeInformation, R: TypeInformation](
      ...
      patternFlatSelectFunction: PatternFlatSelectFunction[T, R]): DataStream[Either[L, R]] = {
  ...
  def flatSelect[L: TypeInformation, R: TypeInformation](
    ...
    asScalaStream(
      jPatternStream
        .flatSelect(outputTag, cleanedTimeout, implicitly[TypeInformation[R]], cleanedSelect))
  }
  ...
  def select[L: TypeInformation, R: TypeInformation](
      ...
      patternSelectFunction: Map[String, Iterable[T]] => R): DataStream[Either[L, R]] = {
  ...
  def select[L: TypeInformation, R: TypeInformation](outputTag: OutputTag[L])(
      patternTimeoutFunction: (Map[String, Iterable[T]], Long) => L)(
      patternSelectFunction: Map[String, Iterable[T]] => R): DataStream[R] = {
